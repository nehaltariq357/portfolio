      ...
      <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-20'>
        ...
        <div className='grid grid-cols-2 gap-16 items-center lg:mx-auto'>
          <div>
            ...
            <p className='text-base sm:text-lg text-center text-gray-400'>Projects for Friends & Family</p>
          </div>
          <div>
            <Image 
              ...
              className='mx-auto'
            />
            <p className='mt-3 font-bold text-xl text-white text-center'>{aboutInfo.experience} Year</p>
            <p className='text-base sm:text-lg text-center text-gray-400'>Learning Experience</p>
          </div>
          <div>
            <Image 
            ...
            <p className='text-base sm:text-lg text-center text-gray-400'>Small Projects Completed</p>
          </div>
          <div>
            <Image 
            ...
            <p className='text-base sm:text-lg text-center text-gray-400'>Websites Published</p>
          </div>
        </div>
      </div>
    </div>
