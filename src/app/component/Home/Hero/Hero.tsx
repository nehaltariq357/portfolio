        ...
        <div className='flex justify-center flex-col w-4/5 h-full mx-auto'>
          <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap-12'>
            ...
            <div>
                ...
                {/* title */}
                <h1 className='text-bg text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold lg:leading-[3.5rem] md:leading-[3rem] xl:leading-[4rem]'>{BaseInfo.position}</h1>
                {/* description */}
